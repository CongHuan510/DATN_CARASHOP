		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h1 mb-3" style="font-weight: 700;">Thêm danh mục
						mới</h1>
					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-body">
									<sf:form class="form"
										action="${classpath }/admin/category/add-save" method="post"
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group mb-4">
														...
														<sf:input style="height: 38px;" path="name" type="text"
															class="form-control" id="name" name="name"
															placeholder="tên danh mục"></sf:input>
													</div>
												</div>
											</div>
												...
												<div class="col-md-6">
													<div class="form-group mb-4">
														...
														<sf:select path="userCreateCategory.id"
															class="custom-select" id="userCreateCategory">
												...
												<div class="col-md-6">
													<div class="form-group mb-4">
														...
														<sf:select path="userUpdateCategory.id"
															class="custom-select" id="userUpdateCategory">
															<sf:options items="${users }" itemValue="id"
																itemLabel="username"></sf:options>
														</sf:select>
													</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group mb-4">
														...
														<sf:input style="height: 38px;" path="createDate"
															class="form-control" type="date" id="createDate"
															name="createDate"></sf:input>
													</div>
												</div>
												...
												<div class="col-md-6">
													<div class="form-group mb-4">
														...
														<sf:input style="height: 38px;" path="updateDate"
															class="form-control" type="date" id="updateDate"
															name="updateDate"></sf:input>
													</div>
												</div>
											</div>
												...
												<div class="col-md-2">
													<div class="form-group mb-4">
														...
														<sf:select path="status" class="custom-select" id="status"
															name="status">
															<option value="ACTIVE"
																<c:if test="${category.status == 'ACTIVE'}">selected</c:if>>Kích hoạt</option>
															<option value="INACTIVE"
																<c:if test="${category.status == 'INACTIVE'}">selected</c:if>>Không kích hoạt</option>
														</sf:select>
													</div>
												</div>
