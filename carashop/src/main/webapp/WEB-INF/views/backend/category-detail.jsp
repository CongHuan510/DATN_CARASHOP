		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h1 mb-3" style="font-weight: 700;">Chi tiết danh mục</h1>
					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-body">
									<sf:form class="form"
										action="${classpath }/admin/category/detail" method="get"
												...
												<div class="col-md-6">
													<div class="form-group mb-4">
														...
														<sf:input path="name" type="text" class="form-control"
															id="name" name="name" placeholder="tên danh mục"></sf:input>
													</div>
												</div>
											</div>
