		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h1 mb-3" style="font-weight: 700;">Thêm tin tức
						mới</h1>
						...
						<div class="row">
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										<sf:form class="form"
											action="${classpath }/admin/news/add-save" method="post"
											...
											<div class="form-body">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group mb-4">
															...
															<sf:select path="userCreateNews.id"
													...
													<div class="col-md-6">
														<div class="form-group mb-4">
															...
															<sf:select path="userUpdateNews.id"
														...
														<div class="form-group mb-4">
															...
															<sf:select path="status" class="form-control" id="status"
																...
																<option value="INACTIVE"
																	<c:if test="${news.status == 'INACTIVE'}">selected</c:if>>Không hoạt động</option>
															</sf:select>
												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group mb-4">
															<label for="avatarFile">Chọn hình đại diện sản
																phẩm</label> <input id="avatarFile" name="avatarFile"
