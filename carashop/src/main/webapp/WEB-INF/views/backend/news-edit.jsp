		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h1 mb-3" style="font-weight: 700;">Chỉnh sửa tin
						tức</h1>
					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-body">
									<sf:form class="form"
										action="${classpath }/admin/news/edit-save" method="post"
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group mb-4">
														...
														<sf:textarea path="content" id="content" name="content"
															class="form-control" rows="3" placeholder="nội dung..."></sf:textarea>
														<script
												...
												<div class="col-md-12">
													<div class="form-group mb-4">
														<label for="avatarFile">Chọn hình đại diện sản
															phẩm</label> <input id="avatarFile" name="avatarFile" type="file"
