...
<body>
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h1 mb-3" style="font-weight: 700;">Danh sách tin tức</h1>
					...
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										<form action="${classpath }/admin/news/list" method="get">
											<div class="table-responsive">
												<div class="row">
													...
													<div class="col-md-4">
														<div class="form-group mb-4">
															<h3>Tổng số tin tức: ${newsSearch.totalItems }</h3>
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group mb-4">
												...
												<div class="row">
													<div class="col-md-2">
														<div class="form-group mb-4">
															<select class="form-control" id="status" name="status">
																...
																<option value="ACTIVE" <c:if test="${newsSearch.status == 'ACTIVE'}">selected</c:if>>Kích hoạt</option>
																<option value="INACTIVE" <c:if test="${newsSearch.status == 'INACTIVE'}">selected</c:if>>Không kích hoạt</option>
															</select>
														</div>
													</div>
													...
													<div class="col-md-2">
														<input class="form-control" type="date" id="beginDate"
															name="beginDate" value="${newsSearch.beginDate }" />
													</div>
													<div class="col-md-2">
														<input class="form-control" type="date" id="endDate"
															name="endDate" value="${newsSearch.endDate }" />
													</div>

													<div class="col-md-3">
														<input type="text" class="form-control" id="keyword"
															name="keyword" placeholder="Tìm từ khóa" value="${newsSearch.keyword }" />
													</div>
												...
												<table id="zero_config"
													...
													<thead>
														<tr align="center">
															...
															<th scope="col">Hình ảnh tin tức</th>
															<th scope="col">Sơ lược</th>
														...
														<c:forEach var="item" items="${news }"
															...
															<tr>
																...
																<td><img width="100px" height="100px"
																	...
																	class="light-logo"></td>
																<td class="description-column">${item.summary }</td>
																<td class="description-column">${item.content }</td>
																<td>${item.userCreateNews.username }</td>
																<td>${item.userUpdateNews.username }</td>
																...
																<td><a
																	href="${classpath }/admin/news/detail/${item.id }"
																	role="button" class="btn btn-success">Chi tiết</a> <a
																	href="${classpath }/admin/news/edit/${item.id }"
																	role="button" class="btn btn-primary">Sửa</a> <a
																	href="${classpath }/admin/news/delete/${item.id }"
	...
	<script type="text/javascript">
		$( document ).ready(function() {
			...
			//$("#status").val(${newsSearch.status});
			//Dat gia tri cua keyword ung voi dieu kien search truoc do
			//$("#keyword").val(${newsSearch.keyword});
