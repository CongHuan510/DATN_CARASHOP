		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h1 mb-3" style="font-weight: 700;">Chi tiết quyền</h1>

					<div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <sf:form class="form" action="${classpath }/admin/role/detail" method="get" modelAttribute="role" enctype="multipart/form-data">
	                        		 <div class="form-body">
										...
										<div class="row">
	                        		 		<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:select path="userCreateRole.id" class="custom-select" id="userCreateRole">
											...
											<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:select path="userUpdateRole.id" class="custom-select" id="userUpdateRole">
			                                            <sf:options items="${users }" itemValue="id" itemLabel="username"></sf:options>
			                                        </sf:select>
                                        		</div>
	                                    	</div>
												...
												<div class="form-group mb-4">
													<label for="status">Trạng thái:</label>
														<sf:select path="status" class="custom-select" id="status"
															name="status">
															<option value="ACTIVE"
																<c:if test="${role.status == 'ACTIVE'}">selected</c:if>>Kích hoạt</option>
															<option value="INACTIVE"
																<c:if test="${role.status == 'INACTIVE'}">selected</c:if>>Không kích hoạt</option>
														</sf:select>			                                       
                                        		</div>
	                                    	</div>
