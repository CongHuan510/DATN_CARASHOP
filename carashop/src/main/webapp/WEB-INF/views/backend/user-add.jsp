		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h1 mb-3" style="font-weight: 700;">Thêm tài khoản mới</h1>
	                        			...
	                        			<div class="row">
	                        		 		<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:input path="username" type="text" class="form-control" id="username" name="username" placeholder="tên tài khoản"></sf:input>
                                        		</div>
	                                    	</div>
										...
										<div class="row">
	                        		 		<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:input path="name" type="text" class="form-control" id="name" name="name" placeholder="họ và tên"></sf:input>
                                        		</div>
	                                    	</div>
	                        		 		...
	                        		 		<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:input path="mobile" type="text" class="form-control" id="mobile" name="mobile" placeholder="số điện thoại"></sf:input>
                                        		</div>
	                                    	</div>
										</div>
										...
										<div class="row">
	                        		 		<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:select path="userCreateUser.id" class="custom-select" id="userCreateUser">
											...
											<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:select path="userUpdateUser.id" class="custom-select" id="userUpdateUser">
			                                            <sf:options items="${users }" itemValue="id" itemLabel="username"></sf:options>
			                                        </sf:select>
                                        		</div>
	                                    	</div>
