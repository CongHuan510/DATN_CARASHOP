		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h1 mb-3" style="font-weight: 700;">Chi tiết tài khoản</h1>

					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-body">
									<sf:form class="form" action="${classpath }/admin/user/detail"
												...
												<div class="col-md-4">
													<div class="form-group mb-4">
														...
														<img width="250px" height="250px"
															src="${classpath }/FileUploads/${user.avatar }" class="rounded-circle">
													</div>
												</div>
											</div>
