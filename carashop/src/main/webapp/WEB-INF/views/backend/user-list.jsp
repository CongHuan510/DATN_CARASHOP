		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h1 mb-3" style="font-weight: 700;">Danh sách tài
						khoản</h1>
										...
										<form action="${classpath }/admin/user/list" method="get">
											<div class="table-responsive">
												<div class="row">
													...
													<div class="col-md-4">
														<div class="form-group mb-4">
															<h3>Tổng số tài khoản: ${userSearch.totalItems }</h3>
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group mb-4">
												...
												<div class="row">
													<div class="col-md-2">
														<div class="form-group mb-4">
															<select class="form-control" id="status" name="status">
																...
																<option value="ACTIVE"
																	<c:if test="${userSearch.status == 'ACTIVE'}">selected</c:if>>Kích
																	hoạt</option>
																<option value="INACTIVE"
																	<c:if test="${userSearch.status == 'INACTIVE'}">selected</c:if>>Không
																	kích hoạt</option>
															</select>
														</div>
													</div>
													...
													<div class="col-md-2 mb-3">
														<input class="form-control" type="date" id="beginDate"
															name="beginDate" value="${userSearch.beginDate }" />
													</div>
													<div class="col-md-2 mb-3">
														<input class="form-control" type="date" id="endDate"
															name="endDate" value="${userSearch.endDate }" />
													</div>
													...
													<tbody>
														<c:forEach var="user" items="${users }" varStatus="loop">
															<tr>
																...
																<td><a
																	href="${classpath }/admin/user/detail/${user.id }"
																	role="button" class="btn btn-success">Chi tiết</a> <c:if
																		test="${SuperAdmin }">
																		<a href="${classpath }/admin/user/edit/${user.id }"
