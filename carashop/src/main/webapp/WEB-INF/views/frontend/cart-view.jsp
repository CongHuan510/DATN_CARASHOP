										...
										<tbody>
											<c:forEach var="item" items="${cart.productCarts }"
												...
												<tr>
													...
													<td><img
														src="${classpath}/FileUploads/${item.avatar }"></td>
								...
								<div class="col-sm-8 col-lg-6 col-xl-4">
									<div class="cart-subtotal row">
										...
										<div class="col-6 text-right">
											<p id="totalCartPriceId" style="color: #088178;">
												<fmt:formatNumber value="${totalCartPrice }"
													pattern="#,##0₫" />
											</p>
										</div>
									</div>
									<div class="btn-back-shopping row">
										<div class="col-lg-6 col-md-6 mt-3">
											<a href="${classpath }/product"
												class="continue text-uppercase" role="button"
												aria-pressed="true"> <i
												class="fa-solid fa-arrow-left mr-2"></i>Tiếp tục mua hàng
											</a>
										</div>
										<div class="col-lg-6 col-md-6 mt-3">
											<a href="${classpath }/checkout"
												class="checkout text-uppercase" role="button"
												aria-pressed="true">Đặt hàng</a>
										</div>
									</div>
								</div>
							</div>
