				...
				<div class="col-lg-12">
					<div id="form-details">
						<div class="col-12 col-md-6 col-lg-8">
							<sf:form action="/contact-sf-save" method="post" modelAttribute="contact" enctype="multipart/form-data">
								<span>LEAVE A MESSAGE</span>
								<h2>We love to hear from you</h2>
								<sf:input path="txtName" type="text" placeholder="Your name" id="txtName" name="txtName"/> 
								<sf:input path="txtEmail" type="email" placeholder="Email" id="txtEmail" name="txtEmail"/> 
								<sf:input path="txtMobile" type="text" placeholder="Your mobile" id="txtMobile" name="txtMobile"/> 
								<sf:input path="txtAddress" type="text" placeholder="Your address" id="txtAddress" name="txtAddress"/>
								<sf:textarea path="txtMessage" cols="30" rows="10" placeholder="Your Message" id="txtMessage" name="txtMessage"></sf:textarea>
